    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        // Public endpoints
                        .requestMatchers("/api/gamification/*/getUsers").permitAll()
                        .requestMatchers("/api/gamification/*/getBadges").permitAll()
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**").permitAll()
                        // Restricted endpoint for ratings requiring authentication
                        .requestMatchers("/api/gamification/points").authenticated()
